<?php /*a:2:{s:82:"/Users/liangfei/Public/project/origin/application/admin/view/system/login_log.html";i:1559100175;s:75:"/Users/liangfei/Public/project/origin/application/admin/view/base/base.html";i:1558678201;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <blockquote class="layui-elem-quote quoteBox">
        <form class="layui-form">
            <div class="layui-inline">
                ...
                <a class="layui-btn layui-btn-danger down_btn" data-type="reload">下载</a>
            </div>
        </form>
    </blockquote>
...
<script>
    ...
    layui.use(['form', 'layer', 'laydate', 'table', 'laytpl'], function () {
        ...
        $(".down_btn").on("click", function () {
            ...
            location.href= "<?php echo url('/admin/downlog'); ?>" + '?key=' + key + '&starttime=' + starttime + '&endtime=' + endtime;
        });
